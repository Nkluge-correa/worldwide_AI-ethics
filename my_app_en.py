...
modal_article = html.Div(
    [
        dbc.Button('Article 📰', id='open-fs', outline=True, color='warning'),
        dbc.Modal(
            [
                ...
                dbc.ModalBody([
                    ...
                    html.H4([
                        ...
                        dbc.Badge("📊 Power BI Version", href="https://en.airespucrs.org/worldwide-ai-ethics",
                                  color="dark", className="text-decoration-none"),
                        dbc.Badge("📰 Full Article", href="https://doi.org/10.48550/arXiv.2206.11922",
                                  color="dark", className="text-decoration-none"),
                    ])
                ]),
                dbc.ModalFooter(
...
modal_map = html.Div(
    [
        dbc.Button(
            'Publications by Country 🏳️‍🌈', id='open-body-scroll-map', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_institution = html.Div(
    [
        dbc.Button(
            'Institution Type 👩‍💼', id='open-body-scroll-institution', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''Except for institutions like **IBM (5)**, **Microsoft (4)**, and **UNESCO (3)**, **most other institutions do not have more than two published documents**. We can also see that the **bulk of our sample was produced by governmental institutions and private corporations (48%)**,  followed by **CSO/NGO (17%)**, **non-profit organizations (16%)**, and **academic institutions (12,5%)**. ''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                 'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                 'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''However, **this trend only follows if we look at the totality of our sample size**. If we look at documents produced by **continents**, for example, in **North America (69), private corporations (24 = 34,7%) and nonprofit organizations (18 = 26%) produced most documents**, followed by governmental institutions (12 = 17,4%). Meanwhile, when we look at **Europe**, the **global trend is restored**. ''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                               'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                               'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''An in-depth analysis **segmented by countries** shows that the **engagement** of certain types of **AI stakeholders** (i.e., institution types) **differs between countries.** For example, in **China (11),  the majority of documents are produced by academic institutions (5 = 45,4%), while in Germany (20), most documents in our sample were produced by private corporations (6 = 30%), and CSO/NGO (4 = 20%).** Other insights can be found in our [Power BI dashboard](https://en.airespucrs.org/worldwide-ai-ethics).''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_gender = html.Div(
    [
        dbc.Button(
            'Gender 🧍‍♂️ ♂ ☿ ♀ 💃', id='open-body-scroll-gender', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''When removing documents with unspecified authors, we counted a total of **561 male authors (66,6%)** and **281 female authors (33,3%).** The dominance of male authors over female authors is **a trend that can be found in practically every world region and country, regardless of institution type.**''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                          'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                          'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''The gender of the authors was determined by searching their names and profile pictures on different types of platforms (e.g., *LinkedIn, Researchgate,  University websites,  personal websites, etc.*)  through search engines. ''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                 'text-align': 'justify',
                                                                                                                                                                                                                                                                                 'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_principles = html.Div(
    [
        dbc.Button(
            'Citations by Principle ⚖️', id='open-body-scroll-principle', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
fig6 = go.Figure(data=go.Scatter(x=list(dff['Years']), y=list(dff['Nº of Published Documents']), mode='lines+markers',
                                 name='',
                                 line=dict(color='#ff8800', width=6),
                                 marker=dict(size=12),
                                 connectgaps=True,
...
fig6.add_trace(go.Scatter(
    ...
    mode='markers',
    marker=dict(color='#ff8800', size=16),
    hoverinfo='skip'
))
fig6.update_layout(
    xaxis=dict(
            ...
            [
                ...
                dbc.ModalBody([
                    dcc.Markdown('''With respect to the year of publication of the documents from our sample, one can see that **the majority of documents (129 = 64,5%) Were published between the years 2017 and 2019.** What we may call the *"AI ethics boom"* would be the **significant production of documents in the year 2018**, which represents **30,5% (61)** of our entire sample.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                           'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                           'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''**Note:** documents with **unspecified** dates of publication **(27 = 13,5%)** are also quite **prevalent** in our sample.''', style={'font-size': 18,
                                                                                                                                                                          'text-align': 'justify',
                                                                                                                                                                          'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_nature = html.Div(
    [
        dbc.Button(
            'Nature/Content 📝', id='open-body-scroll-nature', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''This type relates to the nature/content of the document, and **three categories** were defined (these categories were *not defined as mutually exclusive*):''', style={'font-size': 18,
                                                                                                                                                                                                           'text-align': 'justify',
                                                                                                                                                                                                           'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''- **Descriptive:** descriptive documents take the effort of presenting factual definitions related to AI technologies. These definitions serve to contextualize "what we mean" when we talk about AI, and how the vocabulary utilized in this field can be understood;''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                      'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                      'text-justify': 'inter-word'}),
                    dcc.Markdown('''- **Normative:** normative documents present norms, ethical principles, recommendations, and imperative affirmations about what such technologies should, or should not, be used/developed for;''', style={'font-size': 18,
                                                                                                                                                                                                                                               'text-align': 'justify',
                                                                                                                                                                                                                                               'text-justify': 'inter-word'}),
                    dcc.Markdown('''- **Practical:** practical documents present development tools to implement ethical principles and norms, be they qualitative (e.g., Self-assessment surveys) or quantitative (e.g., Debiasing Algorithms for ML models).''', style={'font-size': 18,
                                                                                                                                                                                                                                                                         'text-align': 'justify',
                                                                                                                                                                                                                                                                         'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''The majority of our sample is comprised of **normative samples (96%)**, which a **third of the time also presents descriptive contents (55,5%)**, and more **rarely**, **practical** implementations **54 (27%)**.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                  'text-align': 'justify',
                                                                                                                                                                                                                                                                  'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_regulation = html.Div(
    [
        dbc.Button(
            'Regulation 👩‍⚖️', id='open-body-scroll-regulation', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''This type relates to the form of regulation that the document proposes. For this, **three categories** were defined (these categories were *defined as mutually exclusive*):''', style={'font-size': 18,
                                                                                                                                                                                                                            'text-align': 'justify',
                                                                                                                                                                                                                            'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''- **Government-Regulation:** this category is designed to encompass documents made by governmental institutions to regulate the use and development of AI, strictly (Legally binding horizontal regulations) or softly (Legally non-binding guidelines);''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                        'text-align': 'justify',
                                                                                                                                                                                                                                                                                                        'text-justify': 'inter-word'}),
                    dcc.Markdown('''- **Self-Regulation/Voluntary Self-Commitment:** this category is designed to encompass documents made by private organizations and other bodies that defend a form of Self-Regulation governed by the AI industry itself. It also encompasses voluntary self-commitment made by independent organizations (NGOs, Professional Associations, etc.);''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                   'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                   'text-justify': 'inter-word'}),
                    dcc.Markdown('''- **Recommendation:** this category is designed to encompass documents that only suggest possible forms of governance and ethical principles that should guide organizations seeking to use, develop, or regulate AI technologies.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                  'text-align': 'justify',
                                                                                                                                                                                                                                                                                  'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''When we look at the form of regulation proposed by the documents of our sample, **more than half (56%) are only recommendations** to different AI stakeholders, while **24% present self-regulatory/voluntary self-commitment style guidelines**, and only **20%** propose a **form of regulation administered by a given state/country**.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                          'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                          'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_normative = html.Div(
    [
        dbc.Button(
            'Normative Strength 💪', id='open-body-scroll-normative', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''This type relates to the normative strength of the regulation mechanism proposed by the document. For this, **two categories** were defined (these categories were *not defined as mutually exclusive*):''', style={'font-size': 18,
                                                                                                                                                                                                                                                        'text-align': 'justify',
                                                                                                                                                                                                                                                        'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''- **Legally non-binding guidelines:** these documents propose an approach that intertwines AI principles with recommended practices for companies and other entities (i.e., soft law solutions);''', style={'font-size': 18,
                                                                                                                                                                                                                                                'text-align': 'justify',
                                                                                                                                                                                                                                                'text-justify': 'inter-word'}),
                    dcc.Markdown('''- **Legally binding horizontal regulations:** these documents propose an approach that focuses on regulating specific uses of AI on legally binding horizontal regulations, like mandatory requirements and prohibitions.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                         'text-align': 'justify',
                                                                                                                                                                                                                                                                         'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''This lack of convergence to a more **"government based"** form of regulation is reflected in the normative strength of these documents, where the **vast majority (98%) only serve as "soft laws,"** i.e., guidelines that do not entail any form of a legal obligation, while **only 4,5% present more strict forms of regulation.** Since only governmental institutions can come up with legally binding norms (other forms of institutions lack this power), and **governmental institutions produced only 24% of our sample**, some may argue that this imbalance lies in this fact.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''However, **filtering** only the documents produced by **governmental institutions**, the **disproportion does not go away**, with **only 18,7% of documents proposing legally binding forms of regulation**. The countries that seem to be spearheading this still weak trend are **Canada**, **Germany**, and the **United Kingdom**, with Australia, Norway, and the USA coming right behind.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                               'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                               'text-justify': 'inter-word'})
                ]),
                dbc.ModalFooter(
...
modal_impact = html.Div(
    [
        dbc.Button(
            'Impact Scope 💥', id='open-body-scroll-impact', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_divergence = html.Div(
    [
        dbc.Button(
            'Divergence 🤔', id='open-body-scroll-divergence', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
                ...
                dbc.ModalBody([
                    dcc.Markdown('''Here we can see cases of *"principle definition divergence,"* i.e., **divergent forms of defining ethical principles**. As an example, let us look at our most cited principle: **Transparency/Explainability/Auditability.**''', style={'font-size': 18,
                                                                                                                                                                                                                                                                             'text-align': 'justify',
                                                                                                                                                                                                                                                                             'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''When examining the definition proposed in "[ARCC: An Ethical Framework for Artificial Intelligence](https://www.tisi.org/13747):" ''', style={'font-size': 18,
                                                                                                                                                                                  'text-align': 'justify',
                                                                                                                                                                                  'text-justify': 'inter-word'}),
                    dcc.Markdown('''- *"Promote algorithmic transparency and algorithmic audit, to achieve understandable and explainable AI systems. Explain the decisions assisted/made by AI systems when appropriate. Ensure individuals’ right to know, and provide users with sufficient information concerning the AI system’s purpose, function, limitation, and impact."* ''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                               'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                               'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''In comparison with the one provided in "[A practical guide to Responsible Artificial Intelligence (AI)](https://www.pwc.com/gx/en/issues/data-and-analytics/artificial-intelligence/what-is-responsible-ai/responsible-ai-practical-guide.pdf):"''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                'text-align': 'justify',
                                                                                                                                                                                                                                                                                                'text-justify': 'inter-word'}),
                    dcc.Markdown('''- *"To instill trust in AI systems, people must be enabled to look under the hood at their underlying models, explore the data used to train them, expose the reasoning behind each decision, and provide coherent explanations to all stakeholders promptly. These explanations should be tailored to the different stakeholders, including regulators, data scientists, business sponsors, and end consumers."*''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''Both definitions seem similar, but the *"AI-devil is in the details."* Only the **first definition entails the concept of auditing,** which means (in some interpretations) a third-party review of the system in question. Also, while the first document mentions that *"one must explain,"* *"ensure the right,"* and *"provide enough information for people,"* clearly imposing the idea of a *"duty to explain"* (**without specifying who should explain**), together with the *"right to know"*,  the second document says that people have *"to be able to look under the hood"* (**also without specifying who should be able to look**), without bringing the idea of right or duty. Also, **only the second one proposes that this knowledge should be tailored and accessible to different types of stakeholders**, since an explanation fit for a machine learning engineer may not be fit for a consumer of an AI-empowered product.''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''Keeping in mind that the concept of **transparency/interpretability is a well-fundamental idea/concept in AI** (especially machine learning research), being still subject to divergence in its interpretation/application, what kinds of differences may occur when we look at *"not so well defined"* principles, like **human-centeredness.**''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''In "Data, Responsibly (Vol. 1) Mirror, Mirror," (Khan & Stoyanovich, [2020](https://dataresponsibly.github.io/comics/)), we find the following recommendation:''', style={'font-size': 18,
                                                                                                                                                                                                              'text-align': 'justify',
                                                                                                                                                                                                              'text-justify': 'inter-word'}),
                    dcc.Markdown('''- *"Maybe what we need instead is to ground the design of AI systems in people. Using the data of the people, collected and deployed with an equitable methodology as determined by the people, to create technology that is beneficial for the people."*''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                         'text-align': 'justify',
                                                                                                                                                                                                                                                                                                         'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''While in "[Everyday Ethics for Artificial Intelligence](https://www.ibm.com/watson/assets/duo/pdf/everydayethics.pdf)",the following norm is suggested:''', style={'font-size': 18,
                                                                                                                                                                                                       'text-align': 'justify',
                                                                                                                                                                                                       'text-justify': 'inter-word'}),
                    dcc.Markdown('''- *"AI should be designed to align with the norms and values of your user group in mind."*''', style={'font-size': 18,
                                                                                                                                          'text-align': 'justify',
                                                                                                                                          'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''The first document mentions ideas like *"the use of an equitable methodology"* and *"technology that is beneficial for the people."* This idea of *"people"* seems to refer to a large and diverse group (perhaps "all people"). Meanwhile, the second specifically states *"your user group in mind,"*  which could mean *"a small and select group of people,"* if that is what the designers have in mind as *"their users."*''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                'text-justify': 'inter-word'}), html.Br(),
                    ...
                    dcc.Markdown('''- While most documents interpret accountability/liability as *“developers being responsible for their projects”* (e.g., “[Declaration of Ethical Principles for AI in Latin America](https://ia-latam.com/etica-ia-latam/)”), **some documents also put this responsibility on users**, and even algorithms “themselves” (e.g., “[The Ethics of Code: Developing AI for Business with Five Core Principles](https://www.sage.com/~/media/group/files/business-builders/business-builders-ethics-of-code.pdf?la=en)”).''', style={'font-size': 18,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     'text-align': 'justify',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     'text-justify': 'inter-word'}), html.Br(),
                    dcc.Markdown('''Besides the ones mentioned above, many other forms of comparisons can be made using our dataset (available for download at the bottom of this page).''', style={'font-size': 18,
                                                                                                                                                                                                    'text-align': 'justify',
                                                                                                                                                                                                    'text-justify': 'inter-word'}),
                ]),
                dbc.ModalFooter(
...
offcanvas = html.Div(
    [
        ...
        dbc.Button(
            'Ethical Principles ⚖️', id='open-offcanvas', outline=True, color='warning', n_clicks=0
        ),
        dbc.Offcanvas(
