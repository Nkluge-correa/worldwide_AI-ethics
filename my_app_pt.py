...
modal_article = html.Div(
    [
        dbc.Button('Artigo 📰', id='open-fs', outline=True, color='warning'),
        dbc.Modal(
            [
...
modal_map = html.Div(
    [
        dbc.Button(
            'Publicações por País 🏳️‍🌈', id='open-body-scroll-map', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_institution = html.Div(
    [
        dbc.Button(
            'Instituições 👩‍💼', id='open-body-scroll-institution', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_gender = html.Div(
    [
        dbc.Button(
            'Gênero 🧍‍♂️ ♂ ☿ ♀ 💃', id='open-body-scroll-gender', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_principles = html.Div(
    [
        dbc.Button(
            'Citações por Princípio ⚖️', id='open-body-scroll-principle', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_years = html.Div(
    [
        dbc.Button(
            'Nº de Publicações por Ano 📅', id='open-body-scroll-years', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_nature = html.Div(
    [
        dbc.Button(
            'Natureza/Conteúdo 📝', id='open-body-scroll-nature', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_regulation = html.Div(
    [
        dbc.Button(
            'Regulação 👩‍⚖️', id='open-body-scroll-regulation', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_normative = html.Div(
    [
        dbc.Button(
            'Força Normativa 💪', id='open-body-scroll-normative', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_impact = html.Div(
    [
        dbc.Button(
            'Escopo de Impacto 💥', id='open-body-scroll-impact', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
modal_divergence = html.Div(
    [
        dbc.Button(
            'Divergências 🤔', id='open-body-scroll-divergence', outline=True, color='warning', n_clicks=0
        ),
        dbc.Modal(
            [
                dbc.ModalHeader(dbc.ModalTitle(dcc.Markdown(
...
offcanvas = html.Div(
    [
        ...
        dbc.Button(
            'Princípios Éticos ⚖️', id='open-offcanvas', outline=True, color='warning', n_clicks=0
        ),
        dbc.Offcanvas(
